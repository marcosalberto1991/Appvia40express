...
<div class="row">
    <div class="col-lg-12 ">
      ...
      <form ref="form"   v-on:submit.prevent="formulario()">
        <div class="row">
          <div class="col-md-12 row">
            <input type="hidden" v-model="input_EstadoTramite_id">
 ...
 //   Select2
  ...
  methods: {
    ...
    formulario(){
      ...
      const data = {
        id: this.input_EstadoTramite_id,
        id :this.input_id,
      ...
      if(this.editar_dato == true){
        axios.put(`/EstadoTramite/${this.input_EstadoTramite_id}`, data)
        .then(response => {
        ...
        axios.post(`/EstadoTramite`, data).then(response => {
            const datos = response.data;
            if(response.data.errors){
              this.$toastr.warning("Verifique los datos", "Verifique los datos");
              this.validacion=response.data.errors;
    ...
    show_registro(data_id){//show_registro
      ...
      axios.get(`/EstadoTramite/${data_id}`).then(response => {
            ...
            if(!response.data){
              ...
              this.input_EstadoTramite_id = data.id
