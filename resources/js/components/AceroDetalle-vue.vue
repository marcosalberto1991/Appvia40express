...
export default {
  ...
  methods: {
    consulta(page = 1) {
      ...
      axios
        .get(`Api/AceroDetalle/${this.input_Acero_id}/consulta_data`)
        .then((response) => {
    ...
    formulario() {
      ...
      formData.append('registro_fotografico', this.input_registro_fotografico);
        ...
        axios.post(`Api/AceroDetalles_update/${this.input_AceroDetalles_id}`, formData,{ headers:{'Content-Type':'multipart/form-data'}})
