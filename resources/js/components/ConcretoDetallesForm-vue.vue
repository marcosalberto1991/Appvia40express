        ...
        <div class="row">
          <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4 col-sm-12">
                ...
                <input type="text" v-model="input_titulo" placeholder="titulo" class="form-control"  aria-describedby="emailHelp" >
                <div class="invalid-feedback" style ="display:block" v-for="data in validacion.titulo" v-bind:key="data.titulo" >
                    <b>{{data}}</b>
                </div>
            </div>
            ...
            <div class="form-group col-md-3 col-sm-12">
              ...
              <b-alert show v-for="data in validacion.concreto_id" v-bind:key="data.concreto_id" variant="danger">
                {{data}}
              </b-alert>

                <div class="invalid-feedback" style ="display:block" v-for="data in validacion.concreto_id" v-bind:key="data.concreto_id" >
                                            <b>{{data}}</b>
                </div>
                </div>
 ...
 //   Select2
  ...
  methods: {
    ...
    formulario(){
      ...
      const data = {
        id: this.input_ConcretoDetalles_id,
        id :this.input_id,
        titulo :this.input_titulo,
      ...
      if(this.editar_dato == true){
        ...
        axios.post(`/ConcretoDetalles`, data).then(response => {
            const datos = response.data;
            if(response.data.errors){
              this.$toastr.warning("Verifique los datos", "Verifique los datos");
              this.validacion=response.data.errors;
