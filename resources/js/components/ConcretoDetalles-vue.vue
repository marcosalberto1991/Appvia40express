      ...
      <div class="col-lg-12">
        ...
        <div class="main-card mb-3 card">
          <div class="card-body">
            ...
            <div class="col-12">
              <!--
        <b-button v-if="$can('ConcretoDetalles Anadir')"  @click='anadir_registro()' type='button' class='btn btn-wangir btn-lg' data-toggle='button' size='sm' aria-pressed='false' variant='success' style='margin-bottom: 5px; margin: 5px;'>Añadir registro
        </b-button>
        -->
              <!--
              <router-link
                v-if="$can('ConcretoDetalles Anadir')"
                :to="{ name: 'concretodetallesformadd', params: { id: 0 } }"
              >
                <a
      ...
      <b-form @submit="formulario()">
        <div class="row">
         ...
         <div class="col-md-4 col-sm-12">
          ...
          <img width="100%" :src="'/Appvia40express/Appvia40express/Concreto_file/'+this.input_registro_fotografico" alt="">
